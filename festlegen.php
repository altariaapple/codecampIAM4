        ...
        <div class="row">
            ...
            <label>Neues Password</label>
                  <div class="form-group">
                      ...
                      <input class="form-control" data-val="true" data-val-length="password must be between 6 and 100 characters long." data-val-length-max="100" data-val-length-min="6" data-val-required="password is required" id="new_Password" name="Password" placeholder="Minimum 6 Zeichen" rows="12" type="password" />
                  </div>
                </div>

              <div class="form-group">
                  <label>Passwort Stärke</label>
                ...
                <div class="form-group">
                  ...
                  <input type="password" name="password2" id="password_confirm" tabindex="2" class="form-control" placeholder="Passwort bestätigen">
                </div>
                <div class="form-group">
                <div class="row">
  ...
  <script>
    ...
    function check_password(){
      ...
      if(new_password != new_password_confirm){
        ...
        var u_id = getUrlParameter('user');

        var send_data = {password:new_password, user_id:u_id}
        var request = $.ajax({
